...
const QuickActions: React.FC<QuickActionsProps> = ({ onOpenShop, onOpenLeaderboard }) => {
  return (
    <div className="w-full grid grid-cols-2 gap-3 mb-6 animate-fade-in" style={{ animationDelay: '0.6s' }}>
      <Button 
        onClick={onOpenShop}
        className="h-12 bg-white/90 hover:bg-white text-white font-semibold shadow-lg transform hover:scale-105 transition-all duration-200 border-0 rounded-xl"
      >
