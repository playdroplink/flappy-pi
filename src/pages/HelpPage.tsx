          ...
          <div className="mobile-container max-w-4xl mx-auto">
            ...
            <div className="flex items-center space-x-4 mb-6 flex-shrink-0">
              ...
              <div className="flex items-center space-x-2">
                ...
                <h1 className="mobile-title text-white">How to Play</h1>
              </div>
            </div>
                ...
                <div className="space-y-6">
                  <Card className="p-4 bg-blue-50 border-blue-200">
                    <div className="flex items-start space-x-3">
                      <Gamepad2 className="h-6 w-6 text-blue-600 mt-1 flex-shrink-0" />
                      <div>
                  ...
                  <Card className="p-4 bg-green-50 border-green-200">
                    <div className="flex items-start space-x-3">
                      <Play className="h-6 w-6 text-green-600 mt-1 flex-shrink-0" />
                      <div>
                  ...
                  <Card className="p-4 bg-purple-50 border-purple-200">
                    <div className="flex items-start space-x-3">
                      <Coins className="h-6 w-6 text-purple-600 mt-1 flex-shrink-0" />
                      <div>
                  ...
                  <Card className="p-4 bg-orange-50 border-orange-200">
                    <div className="flex items-start space-x-3">
                      <Trophy className="h-6 w-6 text-orange-600 mt-1 flex-shrink-0" />
                      <div>
              ...
              <Card className="mobile-card">
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="item-1" className="border-gray-200">
                    <AccordionTrigger className="text-gray-800 text-left">Why does my bird keep falling?</AccordionTrigger>
                  ...
                  <AccordionItem value="item-2" className="border-gray-200">
                    <AccordionTrigger className="text-gray-800 text-left">How do I get better at the game?</AccordionTrigger>
                    <AccordionContent className="text-gray-600">
                  ...
                  <AccordionItem value="item-3" className="border-gray-200">
                    <AccordionTrigger className="text-gray-800 text-left">What can I buy with Flappy Coins?</AccordionTrigger>
                    <AccordionContent className="text-gray-600">
                  ...
                  <AccordionItem value="item-4" className="border-gray-200">
                    <AccordionTrigger className="text-gray-800 text-left">How do leaderboards work?</AccordionTrigger>
                    <AccordionContent className="text-gray-600">
                  ...
                  <AccordionItem value="item-5" className="border-gray-200">
                    <AccordionTrigger className="text-gray-800 text-left">Can I play offline?</AccordionTrigger>
                    <AccordionContent className="text-gray-600">
